...
function view (state, emit) {
  ...
  return html`
    <body class="code lh-copy w-100 vh-100 overflow-hidden">
      ${state.cache(NavbarTop, "NavbarTop")}
      <main class="pl4 pr4 flex flex-column justify-center bg-washed-blue w-100 h-100 dark-pink">
        <div class="w-100 h-auto flex flex-row">
