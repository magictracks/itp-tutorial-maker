...
let thing1 = new View(document.querySelector("#view1"), document.querySelector("#button1"), "yes", "test1")
let thing2 = new View(document.querySelector("#view2"), document.querySelector("#button2"), "maybe", "test2")
let thing3 = new View(document.querySelector("#view3"), document.querySelector("#button3"), "no", "test3")	
